...
function FeatureCardCTA({ feature, href, className, onCTAClick }: FeatureCardCTAProps) {
  return (
    <div
      className={cn(
        'relative flex flex-row rounded-3xl border border-base-400/8 overflow-hidden',
        className,
      )}
    >
      <div className='flex flex-col p-6 pr-4 w-1/3 mr-2'>
        ...
        <Button onClick={onCTAClick} size='lg' className='font-bold w-full'>
